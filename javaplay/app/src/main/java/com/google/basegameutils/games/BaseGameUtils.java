package com.google.basegameutils.games;
...
public class BaseGameUtils {
    ...
    public static boolean resolveConnectionFailure(Activity activity,
        ...
        if (result.hasResolution()) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(activity, errorCode,
                    requestCode);
            if (dialog != null) {
                dialog.show();
            } else {
    ...
    public static void showActivityResultError(Activity activity, int requestCode, int actResp, int errorDescription) {
        ...
        switch (actResp) {
            ...
            default:
                ...
                errorDialog = GoogleApiAvailability.getInstance().getErrorDialog(activity, errorCode,
                        requestCode, null);
                if (errorDialog == null) {
                    // get fallback dialog
